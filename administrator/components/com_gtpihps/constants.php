...
if(!defined('GT_GLOBAL_FILE_URI')) 
	define('GT_GLOBAL_FILE_URI', JURI::root(true) . '/media/' . GT_COMPONENT_NAME);

// URI
if(!defined('GT_GLOBAL_URI')) 
	define('GT_GLOBAL_URI', JURI::root(true) . '/components/' . GT_COMPONENT_NAME);

// Component URI
if(!defined('GT_GLOBAL_COMPONENT')) 
	define('GT_GLOBAL_COMPONENT', JURI::root(true) . '/?option=' . GT_COMPONENT_NAME);

// Media URI
if(!defined('GT_MEDIA_URI')) 
	define('GT_MEDIA_URI', JURI::root(true) . '/media/'. GT_COMPONENT_NAME);
...
// URI
if(!defined('GT_URI')) 
	define('GT_URI', JURI::root(true) . '/components/' . GT_COMPONENT_NAME);
...
if(!defined('GT_ADMIN_URI')) 
	define('GT_ADMIN_URI', JURI::root(true) . '/administrator/components/' . GT_COMPONENT_NAME);

// Component URI
if(!defined('GT_ADMIN_COMPONENT')) 
	define('GT_ADMIN_COMPONENT', JURI::root(true) . '/administrator/?option=' . GT_COMPONENT_NAME);
