...
class JFormFieldAltCalendar extends JFormFieldText
{
	...
	protected function getInput() {
		...
		$input .= preg_replace('/class=".*?"/', 'class="form-control" readonly="" style="background:white"', parent::getInput());
		$input .= '<span class="input-group-addon btn btn-info iconcal"><i class="fa fa-calendar"></i></span></span>';
		return $input;		
	} 
}
