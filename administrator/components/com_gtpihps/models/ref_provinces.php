...
class GTPIHPSModelRef_Provinces extends GTModelList{
	...
	public function __construct($config = array()) {
		if (empty($config['filter_fields'])) {
			$config['filter_fields'] = array('a.name', 'b.name');
		}
	...
	protected function getListQuery() {
		...
		// Select data.
		$query->select($db->quoteName(array('a.id', 'a.name', 'a.iso_code', 'a.published')));
		...
		if (!empty($search)) {
			...
			$search_query[] = $db->quoteName('a.iso_code') . 'LIKE ' . $search;
