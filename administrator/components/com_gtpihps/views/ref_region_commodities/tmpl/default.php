...
$canOrder  = $user->authorise('core.edit.state', 'com_gtpihps.ref_region_commodity');
...
');
?>
<form action="<?php echo JRoute::_('index.php?option=com_gtpihps&view=ref_region_commodities'); ?>" method="post" name="adminForm" id="adminForm">
		...
		<?php else : ?>
			<table class="table table-striped" id="contactList">
				...
				foreach ($this->items as $i => $item) :
					...
					$item->link	= JRoute::_('index.php?option=com_gtpihps&task=ref_region_commodity.edit&id=' . $item->id);
					?>
