...
$canOrder  = $user->authorise('core.edit.state', 'com_gtpihps.ref_category');
...
');
?>
<form action="<?php echo JRoute::_('index.php?option=com_gtpihps&view=ref_categories'); ?>" method="post" name="adminForm" id="adminForm">
		...
		<?php else : ?>
			<table class="table table-striped" id="contactList">
				<thead>
					<tr>
						...
						<th style="width:15%"><div class="text-center">
							<?php echo JHtml::_('grid.sort', 'COM_GTPIHPS_FIELD_PARENT', 'b.name', $listDirn, $listOrder); ?>
						</div></th>
						<th width="1%" class="nowrap center hidden-phone"><div class="text-center">
				...
				foreach ($this->items as $i => $item) :
					...
					$item->link	= JRoute::_('index.php?option=com_gtpihps&task=ref_category.edit&id=' . $item->id);
					?>
