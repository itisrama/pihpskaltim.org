...
class GTPIHPSViewRef_Categories extends GTView {
	...
	function display($tpl = null) {
		...
		GTHelper::addSubmenu('ref_categories');
	...
	protected function addToolbar() {
		...
		JToolbarHelper::title(JText::_('COM_GTPIHPS_PT_CATEGORY'), 'list menu');
	...
	protected function getSortFields() {
		return array(
			...
			'b.name'=> JText::_('COM_GTPIHPS_FIELD_PARENT'), 
		);
	}
}
