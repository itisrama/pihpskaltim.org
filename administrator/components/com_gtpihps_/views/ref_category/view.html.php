...
class GTPIHPSViewRef_Category extends GTView {
	...
	protected function addToolbar()	{
		...
		JToolbarHelper::title($isNew ? JText::_('COM_GTPIHPS_PT_CATEGORY_NEW') : JText::_('COM_GTPIHPS_PT_CATEGORY_EDIT'), 'list menus');
		...
		else
		{
			...
			{
				JToolbarHelper::versions('com_gtpihps.ref_category', $this->item->id);
			}
