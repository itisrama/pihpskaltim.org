...
class GTHelperAccess
{
	...
	public static function getActions()
	{
		...
		$assetName = 'com_gtpihpsbcast';
		$level = 'component';

		$actions = JAccess::getActions('com_gtpihpsbcast', $level);
	 ...
	 */
	public function checkPermission($canDo, $created_by = 0) {
	 ...
	 */
	public function checkViewPermission($view, $layout)
	{
