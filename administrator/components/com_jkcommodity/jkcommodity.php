...
require_once( JK_ADMIN_CORE . DS . 'table.php' );

// Load default controller
require_once( JK_ADMIN_CONTROLLERS . DS . 'controller.php' );

// By default, we use the tables specified at the back end. DISABLED JUST NOW
