...
');
?>
<form action="<?php echo JRoute::_('index.php?option=com_jkcommodity&view=ref_city_commodities'); ?>" method="post" name="adminForm" id="adminForm">
		...
		<?php else : ?>
			<table class="table table-striped" id="contactList">
				...
				foreach ($this->items as $i => $item) :
					...
					$item->link	= JRoute::_('index.php?option=com_jkcommodity&task=ref_city_commodity.edit&id=' . $item->id);
					?>
