...
<form action="<?php echo JRoute::_('index.php?option=com_gtpihps'); ?>" method="post" name="adminForm" id="adminForm" class="form-filter" role="form">
	...
	<div class="form-group">
		...
		<?php echo JHtml::_('select.genericlist', $displayData->provinceOptions, 'filter_province_ids[]', 'class="form-control" size="7" multiple="multiple"', 'value', 'text', $displayData->state->get('filter.province_ids'));?>		
	</div>
	<div class="form-group" id="regency_ids">
	...
	<div class="form-group" id="showMarket">
