...
<div id="alert" class="alert alert-info text-center" role="alert">
	<i class="fa fa-info-circle" style="font-size: 8em"></i>
	<h3><?php echo JText::_('COM_GTPIHPS_REPORT_SELECT_FILTER');?></h3>
	<?php echo JText::_('COM_GTPIHPS_REPORT_SELECT_FILTER_DESC');?>
	<br/><br/>
</div>
