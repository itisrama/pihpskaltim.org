...
$objPHPExcel->getActiveSheet()->mergeCells('C'.$rowNum.':E'.$rowNum);
$objPHPExcel->getActiveSheet()->SetCellValue('C'.$rowNum, ($this->provinces)? $this->provinces : JText::_('COM_GTPIHPS_ALL_PROVINCES'));
