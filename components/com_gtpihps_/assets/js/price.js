...
(function($) {
	$(window).load(function() {
		$('#jform_province_id').change(function() {
			loadOptions($('#jform_regency_id'), 'price.loadRegencies', { 'province_id' : $('#jform_province_id').val() });
			getLatestPrices();
		});

		$('#jform_regency_id').change(function() {
			loadOptions($('#jform_market_id'), 'price.loadMarkets', { 'regency_id' : $('#jform_regency_id').val() });
			getLatestPrices();
		});
