...
if($this->items) {
	...
	$chart = GTHelperFlot::loadChart('gtchart'.$menu_id, $this->items, $this->commodities, $options);
}
		...
		<div class="col-md-9">
			<?php if($this->items):?>
				<div id="report-header">
					...
					<div><span><?php echo JText::_('COM_GTPIHPS_FIELD_PROVINCE') ?></span> : <?php echo $this->tableData->provinces ?></div>
