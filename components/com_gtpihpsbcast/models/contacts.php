...
class GTPIHPSBCastModelContacts extends GTModelList
{
	...
	public function __construct($config = array()) {
		if (empty($config['filter_fields'])) {
			$config['filter_fields'] = array('a.id', 'a.name', 'a.company', 'a.phone', 'a.email');
		}
	...
	protected function getListQuery() {
		...
		// Select project
		$query->select($db->quoteName(array('a.id', 'a.name', 'a.company', 'a.phone', 'a.email')));
		...
		if (!empty($search)) {
			...
			$search_query[] = $db->quoteName('a.company') . 'LIKE ' . $search;
			$search_query[] = $db->quoteName('a.phone') . 'LIKE ' . $search;
