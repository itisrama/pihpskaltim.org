...
class GTPIHPSBCastViewScheduler extends GTView {
	...
	public function display($tpl = null) {
		...
		// Load Script
		//$this->document->addScript(GT_GLOBAL_JS . '/item.js');
		
		// Set page title
		if($layout == 'edit') {
			$this->page_title = $this->isNew ? JText::_('COM_GTPIHPSBCAST_PT_NEW') : JText::_('COM_GTPIHPSBCAST_PT_EDIT');
			$this->page_title = str_replace('%s', JText::_('COM_GTPIHPSBCAST_PT_SCHEDULER'), $this->page_title);
		} else {
			$this->page_title = $this->item->title;
		}
