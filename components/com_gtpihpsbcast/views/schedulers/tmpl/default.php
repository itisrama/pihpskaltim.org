...
<div id="com_gtpihpsbcast" class="scheduler-page<?php echo $this->params->get('pageclass_sfx'); ?>">
			...
			<thead>
				<tr>
					...
					<th class="text-center">
						<?php echo JText::_('COM_GTPIHPSBCAST_FIELD_GROUPS'); ?>
					</th>
					<th width="20%"  class="text-center">
						<?php echo JText::_('COM_GTPIHPSBCAST_FIELD_SCHEDULES'); ?>
					</th>
