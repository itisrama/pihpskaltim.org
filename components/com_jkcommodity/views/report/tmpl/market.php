	...
	<table id="report" class="table table-striped table-bordered">
		<thead>
			<tr>
				...
				<?php foreach($this->market as $market):?>
					<th style="display:none; text-align: center; vertical-align: middle;"><?php echo $market->name; ?></th>
				<?php endforeach;?>
			</tr>
		</thead>
		<tbody>
			...
			<tr>
				...
				<?php foreach($this->market as $market):?>
					...
					<?php elseif(isset($item[$market->id])): ?>				
						<td style="display:none; text-align: right"><?php echo $item[$market->id]; ?></td>
					<?php else:?>
