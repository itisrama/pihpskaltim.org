	...
	<div id="content" style="width:auto;height:520px;overflow-y:scroll">
		...
		<div>
			...
			<div id="mobileappdetails" $hidden>
				<div class="subtitle"><input name="useWhitelabelledapp" value="$useWhitelabelledapp" type="checkbox" class="whilteappcheckbox" $useWhitelabelledappCheck> Have White-labelled App</div>
