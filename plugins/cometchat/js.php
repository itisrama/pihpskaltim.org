...
if(!empty($_REQUEST['admin'])){
	if(file_exists(dirname(__FILE__).DIRECTORY_SEPARATOR.'writable'.DIRECTORY_SEPARATOR.'cache'.DIRECTORY_SEPARATOR.'admin.js')&&DEV_MODE!=1){
		if(!empty($_SERVER['HTTP_IF_MODIFIED_SINCE'])&&strtotime($_SERVER['HTTP_IF_MODIFIED_SINCE'])==filemtime(dirname(__FILE__).DIRECTORY_SEPARATOR.'writable'.DIRECTORY_SEPARATOR.'cache'.DIRECTORY_SEPARATOR.'admin.js')){
			header("HTTP/1.1 304 Not Modified");
			exit();
		}
		readfile(dirname(__FILE__).DIRECTORY_SEPARATOR.'writable'.DIRECTORY_SEPARATOR.'cache'.DIRECTORY_SEPARATOR.'admin.js');
		$js = ob_get_clean();
	}else{
		...
		$fp = @fopen(dirname(__FILE__).DIRECTORY_SEPARATOR.'writable'.DIRECTORY_SEPARATOR.'cache'.DIRECTORY_SEPARATOR.'admin.js','w');
		@fwrite($fp,$js);
		@fclose($fp);
	}
	$lastModified = filemtime(dirname(__FILE__).DIRECTORY_SEPARATOR.'writable'.DIRECTORY_SEPARATOR.'cache'.DIRECTORY_SEPARATOR.'admin.js');
}else{
	if(!empty($cbfn)){
	...
	$cometchat = array();
	if(file_exists(dirname(__FILE__).DIRECTORY_SEPARATOR.'writable'.DIRECTORY_SEPARATOR.'cache'.DIRECTORY_SEPARATOR.$theme.$cbfn.$color.$lang.$type.$name.'.js')&&DEV_MODE!=1){
		if(!empty($_SERVER['HTTP_IF_MODIFIED_SINCE'])&&strtotime($_SERVER['HTTP_IF_MODIFIED_SINCE'])==filemtime(dirname(__FILE__).DIRECTORY_SEPARATOR.'writable'.DIRECTORY_SEPARATOR.'cache'.DIRECTORY_SEPARATOR.$theme.$cbfn.$color.$lang.$type.$name.'.js')){
			header("HTTP/1.1 304 Not Modified");
			exit();
		}

		readfile(dirname(__FILE__).DIRECTORY_SEPARATOR.'writable'.DIRECTORY_SEPARATOR.'cache'.DIRECTORY_SEPARATOR.$theme.$cbfn.$color.$lang.$type.$name.'.js');
		$js = ob_get_clean();
	}else{
		if(($type!='core'||$name!='default')&&($type!='extension'||($type=='extension'&&$name=='jabber'))&&($type!='external')){
			...
			foreach ($trayicon as $module => $moduleinfo){
				...
				if(file_exists(dirname(__FILE__).DIRECTORY_SEPARATOR."modules".DIRECTORY_SEPARATOR.$module.DIRECTORY_SEPARATOR."lang".DIRECTORY_SEPARATOR."en.php")){
					include_once(dirname(__FILE__).DIRECTORY_SEPARATOR."modules".DIRECTORY_SEPARATOR.$module.DIRECTORY_SEPARATOR."lang".DIRECTORY_SEPARATOR."en.php");
				...
				if(file_exists(dirname(__FILE__).DIRECTORY_SEPARATOR."modules".DIRECTORY_SEPARATOR.$module.DIRECTORY_SEPARATOR."lang".DIRECTORY_SEPARATOR.$lang.".php")){
					include_once(dirname(__FILE__).DIRECTORY_SEPARATOR."modules".DIRECTORY_SEPARATOR.$module.DIRECTORY_SEPARATOR."lang".DIRECTORY_SEPARATOR.$lang.".php");
					$traylanguage = $module.'_language';
			...
			$cometchat['settings']['tapatalk'] = defined('TAPATALK');
		...
		$fp = @fopen(dirname(__FILE__).DIRECTORY_SEPARATOR.'writable'.DIRECTORY_SEPARATOR.'cache'.DIRECTORY_SEPARATOR.$theme.$cbfn.$color.$lang.$type.$name.'.js','w');
		@fwrite($fp,$js);
		@fclose($fp);
	}
	$lastModified = filemtime(dirname(__FILE__).DIRECTORY_SEPARATOR.'writable'.DIRECTORY_SEPARATOR.'cache'.DIRECTORY_SEPARATOR.$theme.$cbfn.$color.$lang.$type.$name.'.js');
}
