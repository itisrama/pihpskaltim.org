    ...
    $.crfacebook = (function() {
            return {
                ...
                sendChatroomMessage: function(chatboxtextarea) {
                    ...
                    var textareaHeight = parseInt($('textarea.cometchat_textarea').css('height')) + 4 + 4;//Padding + padding of cometchat_wrapper
                ...
                loadRoom: function() {
                    ...
                    $('#currentroomtab').css('display','block').find('.activeRoom_'+roomno).addClass('tab_selected');
                    ...
                    $('.cometchat_prependMessages_container > .cometchat_prependMessages').attr('onclick','jqcc.facebook.prependCrMessagesInit('+roomno+')');

                    $('#currentroom_convo').attr('onscroll','jqcc.facebook.chatScroll('+roomno+')');
                ...
                loadChatroomList : function(item) {
                    ...
                    var activeChatroomhtml = jqcc.facebook.activeChatrooms(item);
                    var temp = '';
                ...
                displayChatroomMessage: function(item,fetchedUsers) {
                    ...
                    $.each(item, function(i,incoming) {
                        ...
                        if (message != '' && incoming.chatroomid == jqcc.cometchat.getChatroomVars('currentroom')) {
                                ...
                                if (jqcc.cometchat.getChatroomVars('owner') || jqcc.cometchat.getChatroomVars('isModerator') || (incoming.fromid == settings.myid && jqcc.cometchat.getChatroomVars('allowDelete') == 1)) {
                                    ...
                                    $(".delete_msg").mouseover(function() {
                                        $(this).css('visibility','visible').find(".hoverbraces").css('text-decoration','underline');
                                    });
                    ...
                    prependCrMessages:function(id,data){
                        ...
                        if((count - parseInt(settings.prependLimit) < 0)){
                            ...
                            jqcc('.cometchat_prependMessages').attr('onclick','jqcc.facebook.prependCrMessagesInit('+id+')');
                        }
                        $[calleeAPI].groupbyDate();
                    },
