    ...
    $.crglass = (function() {
            return {
                ...
                sendChatroomMessage: function(chatboxtextarea) {
                    ...
                    var textareaHeight = parseInt($('.cometchat_tabcontentinput').outerHeight(true));
                ...
                addChatroomMessage: function(fromid,incomingmessage,incomingid,selfadded,sent,fromname,calledfromsend, chatroomid) {
                    ...
                    if(message != '' && chatroomid == jqcc.cometchat.getChatroomVars('currentroom')) {
                        if ($("#cometchat_message_"+incomingid).length > 0) {
                            $("#cometchat_message_"+incomingid).find("div.cometchat_chatboxmessagecontent").html(message);
                        } else {
                            sentdata = '';
                            if (sent != null) {
                ...
                loadRoom: function() {
                    ...
                    $('.cometchat_prependMessages_container > .cometchat_prependMessages').attr('onclick','jqcc.glass.prependCrMessagesInit('+roomno+')');

                    $('#currentroom_convo').attr('onscroll','jqcc.glass.chatScroll('+roomno+')');
                ...
                loadChatroomList : function(item) {
                    ...
                    var activeChatroomhtml = jqcc.glass.activeChatrooms(item);
                    var temp = '';
                ...
                displayChatroomMessage: function(item,fetchedUsers) {
                    ...
                    updateChatroomUsers: function(item,fetchedUsers) {//*append_left*/
                        var temp = '';
                        var temp1 = '';
                        var moderatorhtml = '';
						var userhtml = '';
                    ...
                    prependCrMessages:function(id,data){
                        ...
                        if((count - parseInt(settings.prependLimit) < 0)){
                            ...
                            jqcc('.cometchat_prependMessages').attr('onclick','jqcc.glass.prependCrMessagesInit('+id+')');
                        }
                        $[calleeAPI].groupbyDate();
                    },
...
jqcc.extend(jqcc.glass, jqcc.crglass);
