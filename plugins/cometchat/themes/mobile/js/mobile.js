        ...
        return{
            initialize: function(){
                ...
                if(mobileDevice||location.href.match('extensions/mobiletab/')){
                    ...
                    $(".cometchat_ccmobiletab_redirect ,.cometchat_ccmobiletab_tabalert").live('click', function(){
                        ...
                        url = jqcc.cometchat.getBaseUrl()+'cometchat_popout.php?cookiePrefix='+cookiePrefix+'&basedata='+jqcc.cometchat.getBaseData()+'&ccmobileauth='+jqcc.cometchat.getThemeVariable('ccmobileauth');
                    ...
                    if(amount===0){
                        ...
                        if( typeof(jqcc.cookie("cc_mobilewebapp_open"))=="undefined" || parseInt(jqcc.cookie("cc_mobilewebapp_open")) != 1 ){
                            if(confirm("<?php echo $language[52]; ?>")){
                                amount = 0;
                                $(".cometchat_ccmobiletab_redirect .cometchat_ccmobiletab_tabalert").remove();
                                url = jqcc.cometchat.getBaseUrl()+'cometchat_popout.php?cookiePrefix='+cookiePrefix+'&basedata='+jqcc.cometchat.getBaseData()+'&ccmobileauth='+jqcc.cometchat.getThemeVariable('ccmobileauth')+'#user-'+toid;
                                jqcc.ccmobiletab.openWebapp(url);
                            }else{
            ...
            chatWith: function(id) {
                if(mobileDevice && typeof(id)!='undefined'){
                    amount = 0;
                    $(".cometchat_ccmobiletab_redirect .cometchat_ccmobiletab_tabalert").remove();
                    url = jqcc.cometchat.getBaseUrl()+'cometchat_popout.php?cookiePrefix='+cookiePrefix+'&basedata='+jqcc.cometchat.getBaseData()+'&ccmobileauth='+jqcc.cometchat.getThemeVariable('ccmobileauth')+'&user='+id;
                    jqcc.ccmobiletab.openWebapp(url);
                }
            },
            loggedOut: function(){
