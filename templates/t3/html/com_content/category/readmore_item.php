...
$introimage = JLayoutHelper::render('joomla.content.intro_image', $this->item);
preg_match('@src="([^"]+)"@', $introimage, $image1);
preg_match('@src="([^"]+)"@', $this->item->introtext, $image2);

$image = @$image2[1] ? $image2[1] : $image1[1];
// "
$charcount	= $params->get('trunctext', '500');
$imgwidth	= $params->get('imgwidth');
$imgwidth	= $imgwidth > 0 ? $imgwidth : 'auto';
$imgheight	= $params->get('imgheight');
$imgheight	= $imgheight > 0 ? $imgheight : 'auto';
...
<div class="img-intro-left">
	<img src="<?php echo $image?>" width="<?php echo $imgwidth?>" height="<?php echo $imgheight?>"/>
</div>
